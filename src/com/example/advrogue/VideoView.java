...
public class VideoView extends SurfaceView {
	...
	public final static int FULL_FLAG = 0;

	public final static int SCALE_FLAG = 1;

	public final static int WRAP_FLAG = 2;
	...
	SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
		...
		public void surfaceCreated(SurfaceHolder holder) {
			...
			canvas.drawColor(Color.parseColor("#000000")); // 随便设置背景颜色
